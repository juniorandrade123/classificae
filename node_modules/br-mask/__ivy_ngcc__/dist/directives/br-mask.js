...
BrMaskDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: BrMaskDirective, selectors: [["", "brmasker", ""]], hostBindings: function BrMaskDirective_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("keyup", function BrMaskDirective_keyup_HostBindingHandler($event) { return ctx.inputKeyup($event); })("ngModelChange", function BrMaskDirective_ngModelChange_HostBindingHandler($event) { return ctx.onNgModelChange($event); });
    } }, inputs: { brmasker: "brmasker", formControlName: "formControlName" } });
BrMaskDirective.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: BrMaskDirective, factory: function (t) { return BrMaskDirective.ɵfac(t); } });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(BrMaskDirective, [{
        type: Directive,
        args: [{
                selector: '[brmasker]'
            }]
